...
namespace Model {
    public class Cliente {
        ...
        public Cliente(string nome, string idade, string cpf, string telefone) {
            ...
            Cpf = cpf;
            Telefone = telefone;
            ListCliente.Criar(this);
        }

        public static List<Cliente> Sincronizar() {
            return ListCliente.Sincronizar();
        }

        public static List<Cliente> ListarCliente() {
            return ListCliente.clientes;
        }
        ...
        public static void AlterarCliente(
            ...
            ListCliente.Update(indice, nome, idade, cpf, telefone);
        }

        public static void DeletarCliente(int indice) {
            ListCliente.Delete(indice);
        }
